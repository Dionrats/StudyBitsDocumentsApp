...
/**
 * PoolUtils, adapted from Quindy
 */
public class PoolUtils {

    private static final String TEMP_TXN = "temp.txn";

    private PoolUtils() {}

    private static String[] generateDefaultTxns(String poolIP) {
        return new String[]{
    ...
    public static CompletableFuture<Void> composeConfig(String testPoolIP, String poolName) throws IOException, IndyException {
        File genesisTxnFile = composeGenesisTxnFile(TEMP_TXN, generateDefaultTxns(testPoolIP));
        ...
        return Pool.createPoolLedgerConfig(poolName, createPoolLedgerConfigJSONParameter.toJson());
    }
}
